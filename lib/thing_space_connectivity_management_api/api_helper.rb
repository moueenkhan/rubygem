...
module ThingSpaceConnectivityManagementApi
  ...
  class APIHelper
    ...
    def self.map_type(value, type, _group_name, matches)
      if ThingSpaceConnectivityManagementApi.constants.select do |c|
        ThingSpaceConnectivityManagementApi.const_get(c).to_s == "ThingSpaceConnectivityManagementApi::#{type}"
      end.empty?
    ...
    def self.map_complex_type(value, type, matches)
      obj = ThingSpaceConnectivityManagementApi.const_get(type)
